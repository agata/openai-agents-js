...
import { base64ToArrayBuffer, HEADERS } from './utils';
 ...
 */
export class CloudflareRealtimeWebSocket
  ...
  implements RealtimeTransportLayer
{
  ...
  async #upgradeViaFetch(): Promise<WebSocket> {
